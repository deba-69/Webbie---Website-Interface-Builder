...
{
    echo "<script>window.open('remove_plans.php','_self')</script>";    
}
else if(isset($_POST["submit-btn7"]))
{
    echo "<script>window.open('remove_trainer.php','_self')</script>";    
}
else
{
...
<body>
    ...
    <div class="container">
        ...
        <form action="" method="post" enctype = "multipart/form-data">
            ...
            <input type="submit" class="submit-btn" name="submit-btn2" value = "About section"></input>
            <input type="submit" class="submit-btn" name="submit-btn3" value = "Add Plans"></input>
            <input type="submit" class="submit-btn" name="submit-btn4" value = "Add Trainer"></input>
            <input type="submit" class="submit-btn" name="submit-btn6" value = "Remove plans"></input>
            <input type="submit" class="submit-btn" name="submit-btn7" value = "Remove Trainer"></input>
